...
/* c-java 6 - Linux vs Java SXP binding withdrawal */
...
static struct topo_task_peer_chk sxpd_c_exp_peers[] = {
    ...
    TOPO_TASK_WAIT_FOR_PEER(JAVA_SXPD_D_IP, PORT, true, false, true),
    TOPO_TASK_WAIT_FOR_PEER(JAVA_SXPD_E_IP, PORT, true, true, false),
};

struct topo_task_peer_chk_ctx sxpd_c_exp_peer_ctx =
    TOPO_TASK_WAIT_FOR_PEERS(sxpd_c_exp_peers, 3, true);
...
static struct topo_task topo_task[] = {
    ...
    TOPO_TASK_BINDING_CFG_ADD_INIT("add V4 host binding to sxpd E", SXPD_E,
                                   BINDING1_IPV4_IP, BINDING1_IPV4_LEN,
    ...
    /* configure topology and test binding withdrawal */
    ...
    TOPO_TASK_WAIT_FOR_INIT("synchronization - peers are connected", SXPD_DUMMY,
                            WAIT_TIMEOUT, topo_task_wait_for_sync_cb,
                            &sync_ctx),

    TOPO_TASK_WAIT_FOR_INIT(
        "synchronization - bindings exported/re-exported/withdrawal",
    ...
    TOPO_TASK_BINDING_CFG_DEL_INIT("del V4 host binding from sxpd E", SXPD_E,
                                   BINDING1_IPV4_IP, BINDING1_IPV4_LEN,
                                   PREFIX_IPV4, BINDING1_IPV4_SGT2),
    TOPO_TASK_BINDING_CFG_DEL_INIT("del V4 subnet binding from sxpd E", SXPD_E,
                                   BINDING2_IPV4_IP, BINDING2_IPV4_LEN,
                                   PREFIX_IPV4, BINDING2_IPV4_SGT2),
    TOPO_TASK_BINDING_CFG_DEL_INIT("del V6 host binding from sxpd E", SXPD_E,
                                   BINDING3_IPV6_IP, BINDING3_IPV6_LEN,
                                   PREFIX_IPV6, BINDING3_IPV6_SGT2),
    TOPO_TASK_BINDING_CFG_DEL_INIT("del V6 subnet binding from sxpd E", SXPD_E,
                                   BINDING4_IPV6_IP, BINDING4_IPV6_LEN,
                                   PREFIX_IPV6, BINDING4_IPV6_SGT2),
    ...
    TOPO_TASK_BINDING_CFG_DEL_INIT("del V4 subnet binding from sxpd A", SXPD_A,
                                   BINDING2_IPV4_IP, BINDING2_IPV4_LEN,
                                   PREFIX_IPV4, BINDING2_IPV4_SGT),
    TOPO_TASK_BINDING_CFG_DEL_INIT("del V6 host binding from sxpd A", SXPD_A,
                                   BINDING3_IPV6_IP, BINDING3_IPV6_LEN,
                                   PREFIX_IPV6, BINDING3_IPV6_SGT),
    TOPO_TASK_BINDING_CFG_DEL_INIT("del V6 subnet binding from sxpd A", SXPD_A,
                                   BINDING4_IPV6_IP, BINDING4_IPV6_LEN,
                                   PREFIX_IPV6, BINDING4_IPV6_SGT),

    TOPO_TASK_WAIT_FOR_INIT(
        "wait for binding delete re-exported from A to D", SXPD_D, WAIT_TIMEOUT,
        topo_task_cb_wait_for_bindings, &sxpd_exp_bind_ctx0),

    TOPO_TASK_WAIT_FOR_INIT("synchronization - bindings withdrawal done",
